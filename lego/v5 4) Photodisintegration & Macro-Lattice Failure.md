...
2.  **The Secondary Splice (The Macro-Lattice):** When completed Alpha blocks stack together to build heavy elements, they lock their massive outer Trefoil cores against each other via **Hydrodynamic Phase-Locking**. 
