...
## **4. The Four Hydrodynamic Vectors (Fluid Motions)**

In the UPT, the electron is not a static, solid object; it is a continuous, dynamic fluid engine. The fluid making up the particle is forced to move in four simultaneous, highly specific geometric vectors. 
...
* **The Mechanics:** As the fluid pumps through the closed loop of distance $2\pi R_{torus}$, it generates a massive, continuous macroscopic current in the surrounding ocean. 
* **The Output:** This continuous circular pumping is the physical hydrodynamic origin of the **Magnetic Dipole Moment**.
