...
In standard cosmology, the **Galaxy Rotation Problem** represents a critical failure in the Newtonian/Einsteinian gravity model. 

According to legacy mechanics, the orbital velocity ($v$) of a star should be dictated by the visible mass ($M$) inside its orbit and its distance ($r$) from the galactic center:
$$v = \sqrt{\frac{GM}{r}}$$
...
To prevent their math from crashing, mainstream physics injected a massive "ghost variable"—an invisible halo of **Dark Matter** making up 85% of the universe, which conveniently scales perfectly to hold the outer stars in place, despite being entirely undetectable.
